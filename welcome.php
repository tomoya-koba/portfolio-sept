      ...
      <div class="container" class="mx-auto mt-5 mb-5">
        <div class="row mb-5 p-5"  >
          <div class="col-md-6 mt-5 bg-white text-center rounded-3">
            <h3 class="m-3"><span class="badge bg-secondary">FREE</span>  Register Your Account</h3>
            <form action="action.php" method="post" class="row">
              ...
              <div class="col-md-6 form-floating mb-3">
                <input type="pw" class="form-control" id="pw" name="pw"  required>
          ...
          <h3 class="m-3">You have Account?</h3>
            <form action="action.php" method="post" class="row">
              ...
              <button type="submit" class="btn btn-success mb-3 mx-auto" style="width:80%" name="login">Login</button>
